$(document).ready(function() {
	...
	let fillVetTable = function(data, staticDir) {
		/*
	...
	let preselectBoxes = function(data) {
	    console.log(data);
	...
	let initialise = function(staticDir, jobId) {
